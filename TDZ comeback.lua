...
local Window = redzlib:MakeWindow({
  Title = "TDZ Hub : Blox Fruit",
  SubTitle = "TDZ Hub đã come back",
  SaveFolder = "NejiHub.lua"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://122325089010707", BackgroundTransparency = 0 },
...
Tabs.Info:AddSection("Information")
    ...
    Title = "TikTok - Tao la Green",
    Description = "Flow Me!!!",
    Logo = "rbxassetid://122325089010707",
    Invite = "@taolagreen",
})
    Tabs.Info:AddDiscordInvite({
    Title = "Discord - TDZHub",
    Description = "Vào Discord Để Nhận Thông Báo Cập Nhật Script!!!",
    Logo = "rbxassetid://122325089010707",
    Invite = "https://discord.gg/Coconcacthamlamvuathoi",
})
...
AttackDropdown = Tabs.Main:AddDropdown({
    ...
    Options = {"Normal Attack","Fast Attack","TDZ Hub"},
    Default = "Fast Attack",
    Callback = function(Value)
            ...
            if char and char:FindFirstChild("HumanoidRootPart") then
                ...
                if _G.BuyingMelee == true or _G.Raiding or _G.Level or _G.AutoFarm then 
                    if not char:FindFirstChild("NEJI_FIX_ESP") then
                        ...
                        h.Name = "NEJI_FIX_ESP"
                        h.FillColor = Color3.fromRGB(0, 170, 255) -- Màu đỏ đặc trưng của NEJI Hub
